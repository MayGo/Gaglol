 ...
 */
@ContextConfiguration(locations = {"classpath:ee/maix/gaglol/system-test-config.xml"})
...
//	private RewardNetwork rewardNetwork;
	...
	@Test
	public void testForDomainObjectCreating() {
		String hash="sdfsdfsdfsdfds";
		Pic pic=new Pic(hash);
		assertEquals(hash,pic.getHash());
